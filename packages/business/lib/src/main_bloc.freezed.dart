...
class _$MainLoadedState implements MainLoadedState {
  const _$MainLoadedState({required this.userModel});
  ...
  @override
  String toString() {
    return 'MainBlocState.loaded(userModel: $userModel)';
  }
...
abstract class MainLoadedState implements MainBlocState {
  const factory MainLoadedState({required final UserModel userModel}) =
      _$MainLoadedState;
...
class __$$_MainSetEventCopyWithImpl<$Res>
  ...
  __$$_MainSetEventCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_MainSetEvent));

  @override
  _$_MainSetEvent get _value => super._value as _$_MainSetEvent;
